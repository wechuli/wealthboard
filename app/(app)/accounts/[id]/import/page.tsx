        ...
        {account.trackingMode === "positions" ? (
            ...
            <Card className="mb-5">
              ...
              <CardContent className="space-y-3 text-sm leading-6 text-slate-400">
                <p>
                  ...
                  effective-dated prices. Every record uses a stable external
                  ID. Any invalid interdependent event blocks the complete
                  commit.
                </p>
          ...
          <>
            <Card className="mb-5">
              ...
              <CardContent className="space-y-3 text-sm leading-6 text-slate-400">
                <p>
                  Each row requires a stable, case-sensitive external ID.
                  Amounts use {account.currency} precision. Dates must be
                  non-future YYYY-MM-DD values. Opening balances and transfers
                ...
                <div className="border-t border-white/[0.06] pt-3">
                  ...
                  <p className="mt-2 text-xs text-slate-500">
                    JSON uses the same fields inside a strict version 1
                    envelope. Report row numbers refer to CSV file lines or
                    1-based JSON array positions.
                  </p>
                </div>
