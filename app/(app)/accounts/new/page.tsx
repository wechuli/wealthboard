  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <Card>
        ...
        <CardContent><AccountForm categories={categories} action={createAccountAction} idempotencyKey={crypto.randomUUID()} today={dateInputForTimezone(settings.timezone)} currencies={currencyConfiguration.enabledCurrencies} baseCurrency={currencyConfiguration.baseCurrency} /></CardContent>
      </Card>
    </div>
  );
}
