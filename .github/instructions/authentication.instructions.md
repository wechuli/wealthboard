...
- Test signup for the first and subsequent users, absence of alternate user-creation paths, case-insensitive username collisions, generic login errors, cookie attributes, expiry, disabled users, per-user invalidation, and concurrent users.
