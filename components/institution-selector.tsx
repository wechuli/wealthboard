    ...
    <>
      ...
      >
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed inset-x-3 top-1/2 z-50 max-h-[85vh] -translate-y-1/2 overflow-y-auto rounded-2xl border border-white/10 bg-[#121918] p-5 shadow-2xl outline-none sm:left-1/2 sm:w-full sm:max-w-lg sm:-translate-x-1/2">
