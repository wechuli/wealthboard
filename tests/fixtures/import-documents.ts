...
export async function spreadsheetFixture(
  options: { formula?: boolean; external?: boolean } = {},
) {
  const archive = new JSZip();
  archive.file(
    "xl/workbook.xml",
    '<workbook xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships"><sheets><sheet name="Activity" sheetId="1" r:id="rId1"/></sheets></workbook>',
  );
  archive.file(
  ...
  archive.file(
    ...
    `<worksheet><sheetData><row r="1"><c r="A1" t="inlineStr"><is><t>Amount</t></is></c><c r="B1"><v>123.4500</v></c><c r="C1"><v>9007199254740993</v></c>${options.formula ? '<c r="D1"><f>1+1</f><v>2</v></c>' : ""}</row></sheetData></worksheet>`,
  );
